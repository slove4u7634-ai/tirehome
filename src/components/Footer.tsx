  ...
  return (
    <div className="w-full mx-auto max-w-[1600px] px-4 md:px-8 pb-8">
      <footer className="bg-gray-900 text-gray-400 py-12 px-6 md:px-12 rounded-2xl mt-auto shadow-lg">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 text-center md:text-left gap-3 md:gap-0">
          ...
          <div className="md:hidden flex flex-col gap-1 items-center">
            ...
            <p className="mt-2">타이어투데이 | 대표: 아무개</p>
          </div>
